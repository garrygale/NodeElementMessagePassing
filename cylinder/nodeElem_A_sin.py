# -*- coding: utf-8 -*-
"""
Last version @ Dec. 20, 2022, 18:43 PT
...
# torch.save(network.state_dict(),'nodeElemMPalt_Cyl_NoNoise_sin.pt')


# %%
network.cpu()
network.load_state_dict(torch.load('nodeElem_A_sin_Cyl_NoNoise.pt'))
network.to(device)
network.eval()
...
# NN time per step  0.016130138158798216
# overhead per step  0.00010206735134124756
...
plt.xlim((0,2000))
plt.ylim((0.95,1))
plt.title('node-elem MP A, sin')

# %%
# torch.save(r2Save,'cyl_nodeElemAlt_sin.pt')