# -*- coding: utf-8 -*-
"""
Last version @ Nov.24, 2022, 18:42 PT
...
# torch.save(network.state_dict(),'nodeElem_B_Cyl_NoNoise.pt')


# %%
network.cpu()
network.load_state_dict(torch.load('nodeElem_B_Cyl_NoNoise.pt'))
network.to(device)
network.eval()
...
# NN time per step  0.014228113532066345
# overhead per step  7.812583446502685e-05
...
plt.xlim((0,2000))
plt.ylim((0.95,1))
plt.title('node-elem MP B')

# %%
# torch.save(r2Save,'cyl_nodeElem_gelu.pt')
